  ...
  <!-- <div class="row settings">
    ...
    <div class="col-xs-12 col-md-4">
      ...
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="uc-multiple">
        <label class="form-check-label" for="uc-multiple">Multiple files</label>
      </div>
      <div class="form-group">
        <label for="uc-multiple-min">Multiple min:</label>
        <input type="number" class="form-control" id="uc-multiple-min" disabled/>
      </div>
      <div class="form-group">
        <label for="uc-multiple-max">Multiple max:</label>
        <input type="number" class="form-control" id="uc-multiple-max" disabled/>
      </div>
    </div>
  </div> -->
</div>
